                ...
                <center>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <table>
                            ...
                            <tr>
                                <td width="100px"> <label for="name">{{ __('ชื่อผู้ใช้') }}</label></td>
                            ...
                            <tr>
                                <td width="100px"> <label for="password">{{ __('รหัสผ่าน') }}</label></td>
                            ...
                            <tr>
                                <td width="100px"> <label for="password-confirm">{{ __('ยืนยันรหัสผ่าน') }}</label>
                                </td>
